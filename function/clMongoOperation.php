...
class clMongoOperation
{
    ...
    private $spMon;         //特殊情况mongo语句
    private $arShow;        //显示的字段array('field1','field2'),或者是update,insert的值
    private $backVal;      //返回值
    private $mongoDB;      //连接mongodb

    function __construct($collection,$arCond,$spMon,$arShow=array())
    {
        $this->mongoDB = new MongoClient("mongodb://yyz:nj_yyz_312_mongo@localhost:28001/papacamera");
        @$this->arShow=$arShow;
    ...
    function fnOther()
    {
        ...
        $query=$this->collection->$this->spMon;
        $this->backVal = $query;
        return $this->backVal;
    }
